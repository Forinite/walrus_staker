...
const Minted = () => {
    return (
        <div className={'border-1 border-[#98F0E4]/40 rounded-[10px] md:w-[540px]  w-[90%] aspect-[651/683] stroke-on-colored'}>
            <div className={'md:pt-8 pt-4'}>
                <p  className={'text-center md:text-[28px] text-lg font-bold selection:bg-purple-400/30'}>Transaction Successful</p>
            </div>
            <div className={'flex justify-center w-full items-center gap-12 mt-6'}>
                <div className={' w-[50%] md:w-[305px] aspect-[325/328] border border-[#98F0E4] overflow-hidden  rounded-[10px]'}>
                    ...
                    <div className={' relative flex justify-between h-full  overflow-hidden '}>
                        ...
                        <div className={' relative z-30 w-full h-full flex flex-col items-center justify-center'}>
                            <p className={'uppercase font-press-start text-[13px] text-mint-300 mb-3 selection:bg-purple-100/50'}> OG STAKER</p>
                            <Image src={walStakedIcon} alt={'walrus staked Icon'} width={123} height={165} className={' '} />
                            <p className={'uppercase font-press-start text-[20px] text-grape-300 px-4 p-1 text-center mt-4 selection:bg-blue-100/30 '}> Staked for 154 Days</p>
            ...
            <div className={'mt-4'}>
                <p className={'bg-walrus-grape px-6 py-2 mx-auto rounded-lg w-fit cursor-pointer font-inter font-light '}>Check Wallet</p>
            </div>
        </div>
    )
}
